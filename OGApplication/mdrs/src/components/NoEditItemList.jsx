...
const ItemList = ({onItemSelected, itemName, getAllItemApi, createItemApi, deleteItemApi}) => {
    ...
    const updateKeyword = (keyword) => {
        const filtered = allItems.filter((siding) => siding.name.toLowerCase().includes(keyword.toLowerCase()));
        setKeyword(keyword);
